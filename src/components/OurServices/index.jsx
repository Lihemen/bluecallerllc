...
export const OurServices = () => {
  return (
    <section className='services__card'>
      <h3 className='service__sec-title font-serif'>Our Services</h3>
      ...
      <div className='services__grid'>
        <Rotate cascade triggerOnce duration={750}>
          <div className='card'>
            ...
            <h3 className='font-serif'>Web Development</h3>
            <p>
          ...
          <div className='card'>
            ...
            <h3 className='font-serif'>SEO Marketing</h3>
            <p>
          ...
          <div className='card'>
            ...
            <h3 className='font-serif'>App Development</h3>
            <p>
          ...
          <div className='card'>
            ...
            <h3 className='font-serif'>Digital Marketing</h3>
            <p>
          ...
          <div className='card'>
            ...
            <h3 className='font-serif'>Social Media Marketing</h3>
            <p>
          ...
          <div className='card'>
            ...
            <h3 className='font-serif'>Product Design</h3>
            <p>
