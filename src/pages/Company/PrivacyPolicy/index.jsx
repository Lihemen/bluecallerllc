  ...
  return (
    <Opacity className='privacy__policy'>
      ...
      <p className='pb-2r'>
        ...
        shared and/or collect in Bluecaller. This policy is not applicable to
      ...
      <p className='pb-2r'>
        ...
        advertisements and links that appear on Bluecaller, which are sent
      ...
      <p className='pb-2r'>
        Note that Bluecaller has no access to or control over these cookies that
